// Modified from https://github.com/tholman/cursor-effects
...
const min = 7.5, max = 20;
var getDelay = () => Math.floor(Math.random() * (max - min + 1)) + min;
var lastTimeParticleAdded = Date.now(),
    interval = getDelay();
...
function onMouseMove(e) {
  ...
  addParticle(e.clientX, e.clientY, baseImage)
}
